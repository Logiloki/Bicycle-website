...
<head>
  <meta charset="UTF-8">
  <title>SPORTSBICYCLE Products</title>
  <style>
body {
...
<body>
      ...
      <ul>
        ...
        <li class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="sportsbicycle.php">sportsbicycle</a>
            <a href="normalbicycle.php">normalbicycle</a>
            <a href="modifybicycle.php">modifybicycle</a>
          </div>
        </li>
  ...
  <div class="content">
    <h1>Sports bicycle</h1>
    <div class="products">
      <div class="product">
        <img src="sportsbicycle1.jpg" alt="sportsbicycle 1">
        <h3>sportsbicycle 1</h3>
        <div>Rs. 11000</div>
      </div>

      <div class="product">
        <img src="sportsbicycle2.jpg" alt="sportsbicycle 2">
        <h3>sportsbicycle 2</h3>
        <div>Rs. 11200</div>
      </div>

      <div class="product">
        <img src="sportsbicycle3.jpg" alt="sportsbicycle 3">
        <h3>sportsbicycle 3</h3>
        <div>Rs. 11900</div>
      </div>
      
      <div class="product">
        <img src="sportsbicycle4.jpg" alt="sportsbicycle 4">
        <h3>sportsbicycle 4</h3>
        <div>Rs. 12900</div>
      </div>

      <div class="product">
        <img src="sportsbicycle5.jpg" alt="sportsbicycle 5">
        <h3>sportsbicycle 5</h3>
        <div>Rs. 13900</div>
      </div>
    </div>
  </div>
