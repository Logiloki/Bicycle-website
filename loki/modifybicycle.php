...
<head>
  <meta charset="UTF-8">
  <title>modify biycle  Products</title>
  <style>
body {
...
<body>
  ...
  <div class="content">
    <h1>modifybicycle Products</h1>
    <div class="products">
      <div class="product">
        <img src="modifybicycle1.jpg" alt="modifybicycle 1">
        <h3>modifybicycle 1</h3>
        <div>Rs. 11500</div>
      </div>

      <div class="product">
        <img src="modifybicycle2.jpg" alt=" modifybicycle2">
        <h3>modifybicycle2</h3>
        <div>Rs. 11800</div>
      </div>

      <div class="product">
        <img src="modifybicycle3.jpg" alt="modifybicycle 3">
        <h3>modifybicycle 3</h3>
        <div>Rs. 11200</div>
      </div>
      
      <div class="product">
        <img src="modifybicycle4.jpg" alt="modifybicycle 4">
        <h3>modifybicycle 4</h3>
        <div>Rs. 12000</div>
      </div>

      <div class="product">
        <img src="modifybicycle5.jpg" alt="modifybicycle 5">
        <h3>modifybicycle 5</h3>
        <div>Rs. 11600</div>
      </div>
    </div>
  </div>
