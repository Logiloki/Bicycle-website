...
<head>
  <meta charset="UTF-8">
  <title>normal biycle  Products</title>
  <style>
   body {
...
<body>
      ...
      <ul>
        ...
        <li class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="sportsbicycle.php">sports biycle</a>
  ...
  <div class="content">
    <h1>normalbicycle Products</h1>
    <div class="products">
      <div class="product">
        <img src="normalbicycle1.jpg" alt="normalbicycle 1">
        <h3>normalbicycle 1</h3>
        <div>Rs. 11500</div>
      </div>

      <div class="product">
        <img src="normalbicycle2.jpg" alt="normalbicycle 2">
        <h3>normalbicycle 2</h3>
        <div>Rs. 11800</div>
      </div>

      <div class="product">
        <img src="normalbicycle3.jpg" alt="normalbicycle 3">
        <h3>normalbicycle 3</h3>
        <div>Rs. 11200</div>
      </div>
      
      <div class="product">
        <img src="normalbicycle4.jpg" alt="normalbicycle 4">
        <h3>normalbicycle 4</h3>
        <div>Rs. 12000</div>
      </div>

      <div class="product">
        <img src="normalbicycle5.jpg" alt="normalbicycle 5">
        <h3>normalbicycle 5</h3>
        <div>Rs. 11600</div>
      </div>
    </div>
  </div>
